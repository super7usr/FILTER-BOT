...
PICS = (environ.get('PICS', 'https://envs.sh/Ipk.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1927155351').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001986722664'))
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/Ipk.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+96YRQ6CjX1ViMDE0')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+96YRQ6CjX1ViMDE0')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+96YRQ6CjX1ViMDE0') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://Renish.infy.uk')
...
MULTI_CLIENT = False
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '1'))
PING_INTERVAL = int(environ.get("PING_INTERVAL", "12"))  # 20 minutes
if 'DYNO' in environ:
    ON_HEROKU = True
else:
    ON_HEROKU = False
URL = environ.get("URL", "https://mydemo.koyeb.app/")
